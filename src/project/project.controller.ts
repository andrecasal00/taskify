...
export class ProjectController {
  ...
  @ApiForbiddenResponse({
    description: 'user does not have permissions to create a project',
  })
  ...
  @ApiForbiddenResponse({
    description: 'user does not have permissions to get the projects',
  })
  ...
  @ApiForbiddenResponse({
    description: 'user does not have permissions to delete a project',
  })
  ...
  @ApiForbiddenResponse({
    description: 'user does not have permissions to update a project',
  })
  async updateProject(@Body() dto: ProjectDto, @Req() req: Request) {
  ...
  @ApiCreatedResponse({
    description: 'member associate with success',
    type: MemberDto,
  })
  @ApiForbiddenResponse({
    description:
      'user does not have permissions to associate a member to a project',
  })
  async addMemberToProject(@Body() data: MemberDto, @Req() req: Request) {
  ...
  @ApiForbiddenResponse({
    description:
      'user does not have permissions to remove a member from a project',
  })
  async removeMemberFromProject(@Body() data: MemberDto, @Req() req: Request) {
  ...
  @ApiForbiddenResponse({
    description: 'user does not have permissions to get a list of members',
  })
  async getProjectMembers(@Req() req: Request) {
